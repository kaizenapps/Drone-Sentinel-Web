...
const translations = {
  en: {
    ...
    droneDetected: "{label} detected!",
    possibleDrone: "Possible {label}",
    listening: "Listening...",
    ...
    detectionSensitivity: "Detection Threshold:",
    ...
    // About section
    aboutContent:
      "Drone Sentinel is an AI-powered sound detection system designed to identify FPV drones by their distinctive sound signature. Using TensorFlow.js, this web application analyzes audio in real-time to detect drone sounds with high accuracy.",
    systemUsage:
      "The system uses TensorFlow.js and a pre-trained model to detect drone sounds in your environment.",
    howItWorks: "How It Works",
    howToUse: "How To Use",
    howToUseStep1: "Allow microphone access when prompted by the browser",
    howToUseStep2: "Wait for the model to load",
    howToUseStep3:
      "Click the 'Start Detection' button to begin sound detection",
    howToUseStep4:
      "The system will display an alert when it detects FPV drone sounds",
    howToUseStep5: "Click 'Stop Detection' to pause detection",
    note: "Note:",
    microphoneAccessNote:
      "This system requires microphone access to function. If you deny access, you will need to enable it in your browser settings and reload the page.",
  ...
  uk: {
    ...
    droneDetected: '{label} виявлено!',
    possibleDrone: 'Можливий {label}',
    ...
    // About section
    aboutContent:
      "Дрон Вартовий - це система виявлення звуку з підтримкою ШІ, призначена для ідентифікації FPV дронів за їх характерним звуковим підписом.",
    systemUsage:
      "Система використовує TensorFlow.js і попередньо навчену модель для виявлення звуків дронів у вашому середовищі.",
    ...
    howToUseStep3:
      "Натисніть кнопку 'Почати виявлення', щоб почати виявлення звуку",
    howToUseStep4:
      "Система відобразить сповіщення, коли виявить звуки FPV дрона",
    howToUseStep5: "Натисніть 'Зупинити виявлення', щоб призупинити виявлення",
    note: "Примітка:",
    microphoneAccessNote:
      "Ця система потребує доступу до мікрофона для функціонування. Якщо ви відмовите у доступі, вам потрібно буде включити його в налаштуваннях браузера та перезавантажити сторінку.",
  ...
  lv: {
    ...
    // About section
    aboutContent:
      "Drona Sargs ir uz mākslīgo intelektu balstīta skaņas noteikšanas sistēma, kas izstrādāta, lai identificētu FPV dronus pēc to raksturīgā skaņas paraksta. Izmantojot TensorFlow.js, šī tīmekļa lietojumprogramma analizē audio reāllaikā, lai ar augstu precizitāti noteiktu dronu skaņas.",
    systemUsage:
      "Sistēma izmanto TensorFlow.js un iepriekš apmācītu modeli, lai noteiktu dronu skaņas jūsu vidē.",
    ...
    howToUseStep3:
      "Noklikšķiniet uz pogas 'Sākt noteikšanu', lai sāktu skaņas noteikšanu",
    howToUseStep4:
      "Sistēma parādīs brīdinājumu, kad tā noteiks FPV drona skaņas",
    howToUseStep5:
      "Noklikšķiniet uz 'Apturēt noteikšanu', lai pauzētu noteikšanu",
    note: "Piezīme:",
    microphoneAccessNote:
      "Šai sistēmai ir nepieciešama mikrofona piekļuve, lai darbotos. Ja jūs noraidāt piekļuvi, jums to būs jāiespējo pārlūka iestatījumos un jāpārlādē lapa.",
